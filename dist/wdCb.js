(function (global, factory) {
	...
	(factory((global.wdCb = global.wdCb || {})));
	...
	var Log = (function () {
	    ...
	    Log.log = function () {
	        ...
	        if (!this._exec("log", messages)) {
	            exports.root.alert(messages.join(","));
	        }
	    ...
	    Log._exec = function (consoleMethod, args, sliceBegin) {
	        ...
	        if (exports.root.console && exports.root.console[consoleMethod]) {
	            exports.root.console[consoleMethod].apply(exports.root.console, Array.prototype.slice.call(args, sliceBegin));
	            return true;
	        }
	        return false;
	    };
