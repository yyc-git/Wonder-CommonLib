...
declare module 'wonder-commonlib/src' {
    export { Collection } from "wonder-commonlib/src/Collection";
    export { $BREAK, $REMOVE } from "wonder-commonlib/src/global/Const";
    export { root } from "wonder-commonlib/src/global/Variable";
    export { Hash } from "wonder-commonlib/src/Hash";
    export { List } from "wonder-commonlib/src/List";
    export { Log } from "wonder-commonlib/src/Log";
    export { Queue } from "wonder-commonlib/src/Queue";
    export { Stack } from "wonder-commonlib/src/Stack";
    export { AjaxUtils } from "wonder-commonlib/src/utils/AjaxUtils";
    export { ArrayUtils } from "wonder-commonlib/src/utils/ArrayUtils";
    export { ConvertUtils } from "wonder-commonlib/src/utils/ConvertUtils";
    export { DomQuery } from "wonder-commonlib/src/utils/DomQuery";
    export { EventUtils } from "wonder-commonlib/src/utils/EventUtils";
    export { ExtendUtils } from "wonder-commonlib/src/utils/ExtendUtils";
    export { FunctionUtils } from "wonder-commonlib/src/utils/FunctionUtils";
    export { JudgeUtils } from "wonder-commonlib/src/utils/JudgeUtils";
    export { PathUtils } from "wonder-commonlib/src/utils/PathUtils";
}

declare module 'wonder-commonlib/src/Collection' {
    import { List } from "wonder-commonlib/src/List";
...
declare module 'wonder-commonlib/src/global/Const' {
    export const $BREAK: {
        break: boolean;
    };
...
declare module 'wonder-commonlib/src/global/Variable' {
    export var root: any;
}

declare module 'wonder-commonlib/src/Hash' {
    import { Collection } from "wonder-commonlib/src/Collection";
    export class Hash<T> {
...
declare module 'wonder-commonlib/src/List' {
    export class List<T> {
...
declare module 'wonder-commonlib/src/Log' {
    export class Log {
        static info: {
...
declare module 'wonder-commonlib/src/Queue' {
    import { List } from "wonder-commonlib/src/List";
...
declare module 'wonder-commonlib/src/Stack' {
    import { List } from "wonder-commonlib/src/List";
    import { Collection } from "wonder-commonlib/src/Collection";
...
declare module 'wonder-commonlib/src/utils/AjaxUtils' {
    export class AjaxUtils {
        static ajax(conf: any): void;
    }
}

declare module 'wonder-commonlib/src/utils/ArrayUtils' {
...
declare module 'wonder-commonlib/src/utils/ConvertUtils' {
    export class ConvertUtils {
        static toString(obj: any): string;
    }
}

declare module 'wonder-commonlib/src/utils/DomQuery' {
...
declare module 'wonder-commonlib/src/utils/EventUtils' {
...
declare module 'wonder-commonlib/src/utils/ExtendUtils' {
...
declare module 'wonder-commonlib/src/utils/FunctionUtils' {
    export class FunctionUtils {
        static bind(object: any, func: Function): () => any;
    }
}

declare module 'wonder-commonlib/src/utils/JudgeUtils' {
...
declare module 'wonder-commonlib/src/utils/PathUtils' {
